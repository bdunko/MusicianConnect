...
@NamedQueries({
        ...
        @NamedQuery(name = "WishList.findByName", query = "SELECT c FROM WishList c WHERE c.title = :title")
})
...
public class WishList implements Serializable {
    ...
    /* Constructors to create an instance of WishList */
    // Used in PrepareCreate method in WishList
    public WishList() {
    }
    ...
    /*
     Used to compare wishlist objects
     */
    @Override
