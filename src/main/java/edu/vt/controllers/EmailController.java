...
public class EmailController {
    ...
    ************************************************************************************************
    ...
    ======================================================
     */
    public void sendEmail(Friend friend) throws AddressException, MessagingException {
        emailTo(friend);
        ...
        try {
             ...
             */
            transport.connect("smtp.gmail.com", "musicianconnect.team5@gmail.com", "CSD@musicianconnect-1872");
    ...
    //Sets the emailTo variable for the current selected friend
    public void emailTo(Friend friend) {
        User sendTo;
        if(friend.getActive().equals(1)) {
            sendTo = userController.getUserById(friend.getMy_id());
        }
        else {
            int userId = friend.getUser_id();
            sendTo = userFacade.getUser(userId);
        }
        this.setEmailTo(sendTo.getEmail());
    }
}
